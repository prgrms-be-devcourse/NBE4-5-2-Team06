...
export default function AuctionCloseButton({ auctionId, isOngoing }: AuctionCloseButtonProps) {
  ...
  const handleClose = async () => {
    try {
      ...
      toast({
        variant: 'destructive',
        title: '오류',
        description: error instanceof Error ? error.message : '경매 종료 중 오류가 발생했습니다.',
      });
    } finally {
      setIsLoading(false);
    }
